...
<html> 
	<title>My Project Skills | Project Developer User Account</title> 
    <body class='body'>
	...
	<table width="100%" >
        ...
        <tr>
			<td width="100%"  >
				<div id="developerTabs"  class="tabPanel1">
                 	<ul>
                        <li><a href="#manageProfileTab">Manage Profile</a></li>
                        <li><a href="#manageProjectsTab">View Own Project Requests</a></li>
                    ...
                    <div id="manageProjectsTab"> 
                    	<?php require_once("viewOwnProjectRequests.php"); ?>  
                    </div>
